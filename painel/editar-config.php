...
$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, email = :email, telefone = :telefone, endereco = :endereco, instagram = :instagram, marca_dagua = :marca_dagua, assinatura_recibo = :assinatura_recibo, cnpj = :cnpj_sistema where id = 1");
