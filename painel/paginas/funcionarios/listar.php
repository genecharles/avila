...
<td>
	<big><a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$email}','{$telefone}','{$endereco}','{$nivel}','{$cpf}', '{$foto}', '{$lotado}')" title="Editar Dados"><i class="fa fa-edit "></i></a></big>
...
<big><a class="btn btn-primary btn-sm" href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$endereco}','{$ativo}','{$dataF}', '{$senha}', '{$nivel}', '{$foto}','{$cpf}')" title="Mostrar Dados"><i class="fa fa-info-circle "></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, endereco, nivel, cpf, foto, lotado){
		$('#mensagem').text('');
	...
	function mostrar(nome, email, telefone, endereco, ativo, data, senha, nivel, foto, cpf){
