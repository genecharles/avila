			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-8 mb-2">							
								...
								<input type="text" class="form-control" id="endereco" name="endereco" placeholder="Ex. Rua tal, bairro x - Nr">							
						</div>
						...
						<div class="col-md-4 mb-2 col-6">
							...
							<select class="form-select" name="municipio" id="municipio">
							  <?php 
							  	$query = $pdo->query("SELECT * from municipio order by nome asc");
