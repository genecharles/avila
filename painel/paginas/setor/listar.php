...
<td>{$telefone}</td>
<td>
	<big><a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$endereco}','{$municipio}','{$responsavel}','{$telefone}')" title="Editar Dados"><i class="fa fa-edit "></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, endereco, municipio, responsavel, telefone){
		$('#mensagem').text('');
