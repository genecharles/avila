...
$query = $pdo->query("SELECT SUBSTRING_INDEX(nome, ' ', 1) as name_usuario, email, telefone, senha, nivel, foto, endereco from usuarios where id = '$id_usuario'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$linhas = @count($res);
if($linhas > 0){
	$nome_usuario = $res[0]['name_usuario'];
...
if($nivel_usuario == "Gerente"){
	$esc_ger = 'ocultar';
}else if($nivel_usuario == "Fiscal"){
	$esc_fis = 'ocultar';	
}else if($nivel_usuario == "Técnico"){
	$esc_tec = 'ocultar';
}
...
<head>
        ...
        <meta name="Author" content="Rodrigo Avila">
	...
	<body class="ltr main-body app sidebar-mini">
		...
		<div class="page">
			...
			<div>
								...
								<div class="mb-0 navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">
									<div class="" id="navbarSupportedContent-4">
										<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
											...
											<div style="color: #fff; margin-top: 10px;"><?php echo $saudacao . " " . $nome_usuario . "!"; ?></div>
				 ...
				 ?>
					...
					<li class="dropdown nav-item  main-header-message ">
						<a class="new nav-link"  data-bs-toggle="dropdown" href="javascript:void(0);">
							<small><i class="fa fa-street-view" style="color:#d4fae1;"></i></small>
						...
						<div class="dropdown-menu">
							<div class="menu-header-content text-start border-bottom">
								<div class="d-flex">
									<h6 class="dropdown-title mb-1 tx-15 font-weight-semibold">Contemplados</h6>
								</div>
								<p class="dropdown-title-text subtext mb-0 op-6 pb-0 tx-12 "><?php echo $linhas ?> Pessoas</p>
							</div>
					<div class="main-message-list chat-scroll">
						...
						<?php 
							...
							for($i=0; $i<$linhas; $i++){
								...
								//$dtnascF = implode('/', array_reverse(@explode('-', $dtnasc)));									
						?>

						<a href="#" class="dropdown-item d-flex border-bottom">
							<div class="wd-90p">
								<div class="d-flex">
									<h5 class="mb-0 name" style="color:green"><?php echo $res[$i]['nome'] ?></h5>
								</div>
								<!--<p class="mb-0 desc"> </p>-->
								<p class="time mb-0 text-start float-start ms-2"> Situação: <?php echo $res[$i]['evidencia'] ?> </p>
							</div>
						</a>
					...
					<div class="text-center dropdown-footer">
						<a class="btn btn-primary btn-sm btn-block text-center"  href="contemplados">Ver Todos</a>
					</div>
				</div>
			</li>
				...
				<li class="dropdown nav-item  main-header-message ">
					<a class="new nav-link"  data-bs-toggle="dropdown" href="javascript:void(0);">
						<small><i class="fa fa-industry" style="color:#fff3f2;"></i></small>
					...
					<div class="dropdown-menu">
						<div class="menu-header-content text-start border-bottom">
							<div class="d-flex">
								<h6 class="dropdown-title mb-1 tx-15 font-weight-semibold">Empresas</h6>
															
							</div>
							<p class="dropdown-title-text subtext mb-0 op-6 pb-0 tx-12 "><?php echo $linhas ?> Cadastradas</p>
						</div>
							...
							for($i=0; $i<$linhas; $i++){
								 ...
								 ?>
														...
														<a href="#" class="dropdown-item d-flex border-bottom">
															...
															<div class="wd-90p">
																<div class="d-flex">
																	<h5 class="mb-0 name" style="color:red"><?php echo $res[$i]['fantasia'] ?> </h5>
																</div>
																<p class="time mb-0 text-start float-start ms-2"><?php echo $res[$i]['telefone'] ?> </p>
															</div>
														</a>
													...
													<div class="text-center dropdown-footer">
														<a class="btn btn-primary btn-sm btn-block text-center"  href="empresas">Ver Todos</a>
													</div>
												</div>
											</li>
											...
											<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
												...
												<div class="dropdown-menu">
													...
													<span class="<?php echo $esc_todos ?>"><a class="dropdown-item " href="" data-bs-target="#modalConfig" data-bs-toggle="modal"><i class="fa fa-cogs "></i>  Configurações</a>
														</span>
					...
					<aside class="app-sidebar">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide <?php echo $esc_tec ?> <?php echo $esc_fis ?>">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										<i class="fa fa-cog text-white mt-1"></i>
									<span class="side-menu__label" style="margin-left: 15px">Sistema</span><i class="angle fe fe-chevron-right"></i></a>
									<ul class="slide-menu">
									...
									<li class=" "><a class="slide-item" href="situacao"> Status</a></li>
								...
								<li class="slide <?php echo @$menu_cadastros ?>">
									...
									<li class="<?php echo $esc_fis ?>"><a class="slide-item" href="contemplados">Contemplados</a></li>

									<li class="<?php echo $esc_fis ?>"><a class="slide-item" href="empresas">Empresas</a></li>

									<li class="<?php echo $esc_tec ?>"><a class="slide-item" href="parecer"> Parecer</a></li>
								...
								<li class="slide <?php echo @$menu_relatorios ?>">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
										<i class="fa fa-briefcase text-white mt-1"></i>
									<span class="side-menu__label" style="margin-left: 15px">Relatórios</span><i class="angle fe fe-chevron-right"></i></a>
									<ul class="slide-menu">

									<li class="<?php echo @$rel_financeiro ?> ocultar_mobile_app"><a class="slide-item" href="" data-bs-toggle="modal" data-bs-target="#modalRelVisitaCasa"> Casas visitadas</a></li>

									<li class="<?php echo @$rel_sintetico_despesas ?> ocultar_mobile_app"><a class="slide-item" href="" data-bs-toggle="modal" data-bs-target="#modalRelVisitaFiscal"> Fiscal visitas</a></li>

									<li class="<?php echo @$rel_sintetico_receber ?> ocultar_mobile_app"><a class="slide-item" href="" data-bs-toggle="modal" data-bs-target="#modalRelStatusCasa"> Situação das Casas</a></li>
...
<?php } ?>
			...
			<div class="main-footer">
				<div class="container-fluid pt-0 ht-100p">
					 Copyright © <?php echo date('Y'); ?> <a href="javascript:void(0);" class="text-primary">RODRIGOAVILA</a>. Todos os direitos reservados
				</div>
			</div>			<!-- FOOTER END -->
...
<!-- Modal Rel Sintético Recebimentos -->
<div class="modal fade" id="modalRelVisitaCasa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">

			<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel">Relatório por Casas Visitadas
					<smdll>(
						<a href="#" onclick="datas('1980-01-01', 'tudo-Vis-Cas', 'Vis-Cas')">
							<span style="color:#fff" id="tudo-Vis-Cas">Tudo</span>
						</a> /
						<a href="#" onclick="datas('<?php echo $data_atual ?>', 'hoje-Vis-Cas', 'Vis-Cas')">
							<span style="color:blue" id="hoje-Vis-Cas">Hoje</span>
						</a> /
						<a href="#" onclick="datas('<?php echo $data_inicio_mes ?>', 'mes-Vis-Cas', 'Vis-Cas')">
							<span style="color:#fff" id="mes-Vis-Cas">Mês</span>
						</a> /
						<a href="#" onclick="datas('<?php echo $data_inicio_ano ?>', 'ano-Vis-Cas', 'Vis-Cas')">
							<span style="color:#fff" id="ano-Vis-Cas">Ano</span>
						</a>
						)
					</smdll>
				</h4>
			...
			<form method="POST" action="rel/visitas_casas_class.php" target="_blank">
			<div class="modal-body">	
			<div class="row">
				...
				<div class="col-md-4">
							...
							<div class="input-group mb-3">
								...
								<input type="date" name="dataInicial" id="dataInicialRel-Vis-Cas" class="form-control"
						...
						<div class="col-md-4">
							...
							<div class="input-group mb-3">
								...
								<input type="date" name="dataFinal" id="dataFinalRel-Vis-Cas" class="form-control"
									value="<?php echo $data_atual ?>">
							</div>
						</div>
				...
				<div class="col-md-4">					
					...
					<select name="filtro_status" class="form-select">
						...
						if($linhas > 0){
							for($i=0; $i<$linhas; $i++){
								echo '<option value="'.$res[$i]['status'].'">'.$res[$i]['nome'].'</option>';
							}
						}
						?>	
					</select>
...
<div class="modal fade" id="modalRelVisitaFiscal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel">Relatório Visitas por Fiscal
					<small><small>(
			...
			<form method="POST" action="rel/visita_fiscal_class.php" target="_blank">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-5">
							<label>Data Inicial</label>
					...
					<div class="row">
						<div class="col-md-12">					
							<label>Selecione um Fiscal</label>
							<select name="filtro_fiscal" class="form-select">
								<option value="">Tudo</option>
								<?php 
...
<!-- Modal Rel Sintético Despesas -->
<div class="modal fade" id="modalRelStatusCasa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel">Relatório Visitas por Fiscal
					<small><small>(
						<a href="#" onclick="datas('1980-01-01', 'tudo-Sts-Cas', 'Sts-Cas')">
							<span style="color:#fff" id="tudo-Sts-Cas">Tudo</span>
						</a> /
						<a href="#" onclick="datas('<?php echo $data_atual ?>', 'hoje-Sts-Cas', 'Sts-Cas')">
							<span style="color:blue" id="hoje-Sts-Cas">Hoje</span>
						</a> /
						<a href="#" onclick="datas('<?php echo $data_inicio_mes ?>', 'mes-Sts-Cas', 'Sts-Cas')">
							<span style="color:#fff" id="mes-Sts-Cas">Mês</span>
						</a> /
						<a href="#" onclick="datas('<?php echo $data_inicio_ano ?>', 'ano-Sts-Cas', 'Sts-Cas')">
							<span style="color:#fff" id="ano-Sts-Cas">Ano</span>
						</a>
						)
					</small></small>
				</h4>
			...
			<form method="POST" action="rel/situacao_casa_class.php" target="_blank">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-5">
							<label>Data Inicial Cadastro</label>
							<div class="input-group mb-3">
								...
								<input type="date" name="dataInicial" id="dataInicialRel-Sts-Cas" class="form-control"
									value="<?php echo $data_atual ?>">
							</div>
						</div>
						<div class="col-md-5">
							...
							<div class="input-group mb-3">
								...
								<input type="date" name="dataFinal" id="dataFinalRel-Sts-Cas" class="form-control"
									value="<?php echo $data_atual ?>">
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-5">					
							<label>Status</label>
							<select name="filtro_evidencia" class="form-select">
								<option value="">Tudo</option>
								<?php 
								$query = $pdo->query("SELECT * from situacao order by id asc");
								$res = $query->fetchAll(PDO::FETCH_ASSOC);
...
<script type="text/javascript">
    ...
    var file = document.querySelector("#assinatura_recibo").files[0];
